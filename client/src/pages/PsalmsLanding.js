...
class PsalmsLanding extends Component {
  ...
  submitForm(e) {
    ...
    // check for validity
    if (this.state.psalm1 < 1 || this.state.psalm1 > 150 || this.state.psalm2 < 1 || this.state.psalm2 > 150 || this.state.psalm1 === '' || this.state.psalm2 === '') {
      this.setState({
        invalidMsg: 'Please choose a psalm between 1 and 150.',
        psalm1: '',
        psalm2: ''
      })
    }
      ...
      this.setState({
        invalidMsg: 'Please choose two different psalms to compare.',
        psalm1: '',
        psalm2: ''
      })
    }
          ...
          <Col className='mainCol'>
            ...
            <div>
              ...
              <div className='content content--border content--flex'>
                ...
                <Row>
                <Form className='content__form' onSubmit={this.submitForm}>
                  <h3><u>Compare two Psalms.</u></h3>
                    ...
                    <Button type='submit'>Compare these two psalms</Button>
                  </Form>
                </Row> 
